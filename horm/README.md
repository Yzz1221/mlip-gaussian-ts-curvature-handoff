...
This directory contains a local copy of the HORM source from
https://github.com/deepprinciple/HORM at commit
`b4c2a35a28985c72ca47261bad0a96b2bc2ba084`. The local
EquiformerV2 file includes two changes documented in the repository's
[`THIRD_PARTY_NOTICES.md`](../THIRD_PARTY_NOTICES.md). Please cite Cui et al., *Scientific Data* **13**,
37 (2026), DOI: 10.1038/s41597-025-06350-5, when using this model code.
